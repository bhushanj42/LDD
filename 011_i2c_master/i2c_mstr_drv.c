...
static int clk_bcm2835_i2c_set_rate(struct clk_hw *hw, unsigned long rate, unsigned long parent_rate)
{
	...
	dev_err(div->i2c_dev->dev, "parent_rate = %ld, rate = %ld", parent_rate, rate);
	...
	bcm2835_i2c_writel(div->i2c_dev, BCM2835_I2C_DEL, (fedl << BCM2835_I2C_FEDL_SHIFT) | (redl << BCM2835_I2C_REDL_SHIFT));
...
static void bcm2835_fill_txfifo(struct bcm2835_i2c_dev *i2c_dev)
{
	...
	while (i2c_dev->msg_buf_remaining) {
		...
		if (!(val & BCM2835_I2C_S_TXD))
			break;
		bcm2835_i2c_writel(i2c_dev, BCM2835_I2C_FIFO, *i2c_dev->msg_buf);
		i2c_dev->msg_buf++;
...
static void bcm2835_drain_rxfifo(struct bcm2835_i2c_dev *i2c_dev)
{
	...
	while (i2c_dev->msg_buf_remaining) {
		...
		if (!(val & BCM2835_I2C_S_RXD))
			break;
		*i2c_dev->msg_buf = bcm2835_i2c_readl(i2c_dev, BCM2835_I2C_FIFO);
		i2c_dev->msg_buf++;
		i2c_dev->msg_buf_remaining--;
	}
}
...
complete:
	...
	bcm2835_i2c_writel(i2c_dev, BCM2835_I2C_S, BCM2835_I2C_S_CLKT | BCM2835_I2C_S_ERR | BCM2835_I2C_S_DONE);
...
static int bcm2835_i2c_probe(struct platform_device *pdev)
{
	...
	/*i2c_dev->regs will store the base address reg value of 0x7e804000*/
	...
	if (ret < 0) {
		...
		dev_err(&pdev->dev, "clock-frequency = %d", bus_clk_rate);
	}
	...
	ret = request_irq(i2c_dev->irq, bcm2835_i2c_isr, IRQF_SHARED, dev_name(&pdev->dev), i2c_dev);
	if (ret) {
	...
	snprintf(adap->name, sizeof(adap->name), "bcm2835 (%s)", of_node_full_name(pdev->dev.of_node));
...
static const struct of_device_id bcm2835_i2c_of_match[] = {
	{ .compatible = "org,i2c-customDrv", .data = &bcm2835_i2c_quirks },
	{},
};
...
MODULE_DESCRIPTION("BCM2835 I2C bus driver taken from i2c-bcm2835.c");
